    ...
    public partial class DeleteBusiness : UserControl
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    searchBusiness();
                    DBConnect.ExecuteNonQuery($"DELETE FROM BUSINESS WHERE idBusiness = {Convert.ToInt32(textBox1.Text)}");
        ...
        {
            var dt = DBConnect.ExecuteQuery($"SELECT name FROM business WHERE idBusiness = '{Convert.ToInt32(textBox1.Text)}'");
